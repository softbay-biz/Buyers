...
function imageFromString($data){
		 ...
		 copy($repertoireUpload.$imageName,$repertoireUpload.'/vignette/800/'.$imageName);											  
		 //On enrgistre le noms ds fichierrs dans un tableau 
		 //petite image 200 * 200
		 fct_redim_image(200,200,'','','',$repertoireUpload.$imageName);
		 copy($repertoireUpload.$imageName,$repertoireUpload.'/vignette/200/'.$imageName);
		 imagedestroy($source);    
